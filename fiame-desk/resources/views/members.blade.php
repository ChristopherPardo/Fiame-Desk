...
<div class="relative rounded-xl overflow-auto p-8">
  <div class="overflow-auto h-80 relative w-1/2 bg-white dark:bg-slate-800 dark:highlight-white/5 shadow-lg ring-1 ring-black/5 rounded-xl flex flex-col divide-y dark:divide-slate-200/5">
    <div class="flex items-center gap-4 p-4">
      <div class="grid grid-cols-4 divide-x text-center	">
        <div class="px-10">Christopher</div>
        <div class="content-center">Pardo</div>
        <div>078 936 06 33</div>
        <div><input type="checkbox" class="w-6 h-6 rounded-full"/></div>
        </div>
    </div>
    <div class="flex items-center gap-4 p-4">
